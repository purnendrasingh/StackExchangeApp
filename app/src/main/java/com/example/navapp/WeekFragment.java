...
public class WeekFragment extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // menu = navigationView.getMenu();
        ...
        String u="https://api.stackexchange.com/2.2/questions?order=desc&sort=activity&tagged=java&site=stackoverflow";
        try{


            String path1="https://api.stackexchange.com/2.2/questions?order=desc&sort=activity&tagged=";
